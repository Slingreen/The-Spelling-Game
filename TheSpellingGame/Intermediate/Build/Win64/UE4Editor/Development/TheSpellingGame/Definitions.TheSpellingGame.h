...
#define UE_PROJECT_NAME TheSpellingGame
#define UE_TARGET_NAME TheSpellingGameEditor
#define UE_MODULE_NAME "TheSpellingGame"
...
#define THESPELLINGGAME_API DLLEXPORT
